...
$sections = [
    ...
    [
        ...
        'items' => [
            ...
            ['slug' => 'comp-types',     'label' => 'Comp Types',    'icon' => 'tag'],
        ],
    ],
    [
        'label' => 'Community',
...
if (!function_exists('bbj_v2_admin_icon')) {
    function bbj_v2_admin_icon(string $name): void
    {
        $paths = [
            ...
            'map'            => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 6.75V15m0-8.25l-6 3.75v8.25l6-3.75m0-8.25l6 3.75m0 0v8.25m0-8.25l6-3.75v8.25l-6 3.75m0-8.25v8.25m-6-3.75v3.75"/>',
